...
const adminRoutes: AppRouteRecord[] = [
  // system_admin 路由 - /admin/*
  {
    path: '/admin/dashboard',
    name: 'AdminDashboard',
    component: '/school/dashboard',
    meta: { title: '管理首页', icon: 'ri:home-line', keepAlive: false, roles: ['system_admin'] }
  },
  {
    path: '/admin/colleges',
    name: 'AdminColleges',
  ...
  },
  {
    ...
    meta: { title: '就业预警', icon: 'ri:alert-line', keepAlive: true, roles: ['system_admin'] }
  },
  {
    path: '/admin/company-announcements',
    name: 'AdminCompanyAnnouncements',
    component: '/school/company-announcements',
    meta: { title: '企业公告', icon: 'ri:megaphone-line', keepAlive: true, roles: ['system_admin'] }
  },
  {
  ...
  // school_admin 路由 - /school/*
  {
    path: '/school/dashboard',
    name: 'SchoolDashboard',
    component: '/school/dashboard',
    meta: { title: '学校首页', icon: 'ri:home-line', keepAlive: false, roles: ['school_admin'] }
  },
  {
  ...
  {
    path: '/school/companies',
    name: 'SchoolCompanies',
    component: '/admin/companies',
    meta: { title: '企业管理', icon: 'ri:briefcase-line', keepAlive: true, roles: ['school_admin'] }
  },
  {
  ...
  },
  {
    ...
    name: 'SchoolWarnings',
    component: '/school/warnings',
    meta: { title: '就业预警', icon: 'ri:alert-line', keepAlive: true, roles: ['school_admin'] }
  },
  {
  ...
  },
  {
    ...
    component: '/change/log',
    meta: { title: '更新日志', icon: 'ri:history-line', keepAlive: false, roles: ['school_admin'] }
  }
]
