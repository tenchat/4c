...
const adminRoutes: AppRouteRecord[] = [
  ...
  },
  {
    ...
    meta: { title: '学生管理', icon: 'ri:user-settings-line', keepAlive: true, roles: ['system_admin'] }
  },
  {
    path: '/school/students',
    name: 'AdminStudents',
    component: '/school/students',
    meta: { title: '学生管理', icon: 'ri:user-settings-line', keepAlive: true, roles: ['school_admin'] }
  },
  {
    path: '/admin/warnings',
    name: 'AdminWarnings',
  ...
  },
  {
    ...
    meta: { title: '企业宣讲会', icon: 'ri:calendar-event-line', keepAlive: true, roles: ['system_admin'] }
  },
  {
