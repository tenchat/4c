...
<script setup lang="ts">
  ...
  const roleOptions: RoleOption[] = [
    { value: 'student', label: '学生', username: 'student_1', password: '123456' },
    { value: 'school_admin', label: '学校管理员', username: 'school_admin', password: '123456' },
    { value: 'company_admin', label: '企业', username: 'company_098e200c', password: '123456' },
